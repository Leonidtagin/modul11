...
def introspection_info(obj = None, **kwargs):
    info_dic: dict = {}
    try:
        print(f'\n\033[93mИсследуем объект {obj.__name__}\033]Om')
    except AttributeError:
        print(f'\n\033[93mИсследуем объект {obj}\033]Om')
    ...
    print('Модуль к которому объект пренадлежит:', inspect.getmodule(obj), sep='\n\t')
    info_dic['module'] = inspect.getmodule(obj)
    if inspect.isfunction(obj):
        sign = inspect.isfunction(obj)
